...
// 3. 추상화 abstract : 미완성된 매서드가 단 한개라도 존재하면 추상 클래스다.
// 4. 다형성 polymorphism : 다양한 + 형태 (여러 자식 클래스들을 하나의 부모 타입으로 묶을 수 있다.)
//						  부모 자식간의 형 변환이 가능하다.(upcasting, downcasting, 추상클래스, 인터페이스)
